    ...
    <div className="min-h-screen bg-[#0f0f0f]">
      ...
      <main className="w-full py-6">
        ...
        <div className="hidden lg:flex gap-6 h-[calc(100vh-120px)] min-h-[600px] px-6">
          ...
          {/* Main Content */}
          <section className="flex-1 min-w-0 bg-[#1a1a1a] rounded-2xl p-6 border border-[#333333]" aria-label="News content">
        ...
        <div className="hidden md:flex lg:hidden gap-4 px-4">
          <section className="flex-1 bg-[#1a1a1a] rounded-2xl p-6 border border-[#333333]" aria-label="News content">
            <MainContent news={news} />
          </section>
        </div>
