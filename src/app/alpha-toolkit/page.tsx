            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-[#222222] rounded-xl p-6 border border-[#333333] hover:border-[#ff6b35] transition-colors">
                  ...
                  <button className="w-full bg-[#333333] text-white py-2 px-4 rounded-lg hover:bg-[#444444] transition-colors">
                    Coming Soon
                  </button>
                </div>
              ...
              <div className="bg-[#222222] rounded-xl border border-[#333333] overflow-hidden">
                ...
                <div className="p-6">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-[#333333] rounded-lg">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="bg-[#222222] rounded-lg p-4 border border-[#333333]">
                  ...
                  <button className="w-full bg-[#333333] text-white py-2 px-4 rounded-lg text-sm">
                    Coming Soon
                  </button>
                </div>
              </div>
